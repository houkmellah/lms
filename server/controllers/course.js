...
export const create = async (req, res) => {
    ...
    try {
        ...
        const course = await new Course({ slug: slugify(req.body.name.toLowerCase()), instructor: req.user._id, ...req.body,}).save();
        res.json(course)
        console.log(course)
    } catch (err) {
        console.log(err)
...
export const stripeSuccess = async (req, res) => {
    try {
        ...
        // if session payment status is paid, push course to user course []
