...
const InstructorRevenue = () => {
    ...
    const handlePayoutSettings = async () => {
        try {
            setLoading(true)
            const { data } = await axios.get('/api/instructor/payout-setting')
            ...
            <div className="container">
                <div className="row pt-2">
                    <div className= "col-md-8 offset-md-2 bg-light p-5">
                        <h2>Revenu report <DollarOutlined className="float-right" />{"  "}</h2>
                        ...
                        <small>Update your stripe account details or view pervious payouts.</small>
